...
package kr.co.anitex.golfteachingpro.balloon
...
import kr.co.anitex.golfteachingpro.balloon.annotations.Dp
import kr.co.anitex.golfteachingpro.balloon.annotations.Sp
import kr.co.anitex.golfteachingpro.balloon.databinding.LayoutBalloonBinding
import kr.co.anitex.golfteachingpro.balloon.extensions.*
...
class Balloon(
  ...
  private fun createByBuilder() {
    ...
    when {
        builder.layoutRes != NO_INT_VALUE -> {
