...
public class DefaultPaintingBehavior implements PaintingBehavior {
    ...
    private final CiPaint selectionBoundPaint;
    private final CiPaint selectionAreaPaint;
    private final CiPaint resizingHandlePaint;
    private final CiPaint rotationHandlePaint;
    private final CiPaint referencePointPaint;
